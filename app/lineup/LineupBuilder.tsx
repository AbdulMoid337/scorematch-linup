...
> = {
  ...
  "3-4-3": {
    ...
    positions: [
      ...
      { top: 70, left: 50, role: "CB" },
      { top: 70, left: 70, role: "CB" },
      { top: 50, left: 15, role: "LM" },
      { top: 50, left: 38, role: "CM" },
      { top: 50, left: 62, role: "CM" },
      { top: 50, left: 85, role: "RM" },
      { top: 20, left: 20, role: "LW" },
      { top: 20, left: 50, role: "ST" },
      { top: 20, left: 80, role: "RW" },
    ],
  ...
  "4-2-1-3": {
    ...
    positions: [
      ...
      { top: 70, left: 62, role: "CB" },
      { top: 70, left: 85, role: "RB" },
      { top: 55, left: 35, role: "CDM" },
      { top: 55, left: 65, role: "CDM" },
  ...
  "5-2-1-2": {
    ...
    positions: [
      ...
      { top: 70, left: 70, role: "CB" },
      { top: 70, left: 90, role: "RWB" },
      { top: 50, left: 35, role: "CM" },
      { top: 50, left: 65, role: "CM" },
      { top: 35, left: 50, role: "CAM" },
      { top: 20, left: 35, role: "ST" },
      { top: 20, left: 65, role: "ST" },
    ],
  ...
  "4-1-4-1": {
    ...
    positions: [
      ...
      { top: 70, left: 62, role: "CB" },
      { top: 70, left: 85, role: "RB" },
      { top: 58, left: 50, role: "CDM" },
      { top: 40, left: 15, role: "LM" },
      { top: 40, left: 38, role: "CM" },
      { top: 40, left: 62, role: "CM" },
      { top: 40, left: 85, role: "RM" },
      { top: 15, left: 50, role: "ST" },
    ],
  },
};
